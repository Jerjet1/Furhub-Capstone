# Generated by Django 5.2.1 on 2025-09-29 14:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pet_boarding', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policies', to='FurhubApi.petboarding')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='WalkerRate',
            fields=[
                ('pet_walker', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='FurhubApi.petwalker')),
