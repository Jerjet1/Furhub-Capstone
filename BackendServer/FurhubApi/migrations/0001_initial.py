# Generated by Django 5.2.1 on 2025-10-02 17:11
# Generated by Django 5.2.1 on 2025-10-02 14:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('approved', 'Approved'), ('ongoing', 'Ongoing'), ('checked_in', 'Checked In'), ('checked_out', 'Checked Out'), ('canceled', 'Canceled'), ('completed', 'Completed'), ('rejected', 'Rejected')], default='pending', max_length=15)),
                ('duration_value', models.PositiveIntegerField(blank=True, null=True)),
                ('duration_unit', models.CharField(blank=True, choices=[('hour', 'Hour'), ('day', 'Day'), ('week', 'Week')], max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(upload_to='provider_documents/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('profile_picture', 'Profile Picture'), ('community_post', 'Community Post')], max_length=50)),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pet_boarding', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='boarding_rate', to='FurhubApi.petboarding')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('policy_type', models.CharField(choices=[('late_pickup', 'Late Pickup'), ('cancellation', 'Cancellation')], max_length=50)),
                ...
                ('pet_boarding', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='boarding_policy', to='FurhubApi.petboarding')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='WalkerRate',
            fields=[
                ('pet_walker', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='walker_rate', serialize=False, to='FurhubApi.petwalker')),
                ('per_walk_rate', models.DecimalField(decimal_places=2, max_digits=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('last_edited', models.DateTimeField(auto_now=True)),
                ('pet_walker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policies', to='FurhubApi.petwalker')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='operational_hours', to=settings.AUTH_USER_MODEL)),
            ],
            options={
